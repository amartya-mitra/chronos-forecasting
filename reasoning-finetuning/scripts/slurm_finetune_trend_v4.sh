#!/bin/bash
#SBATCH --job-name=chronos_trend_v4
#SBATCH --partition=hpc-mid
#SBATCH --ntasks=1
#SBATCH --gpus=1
#SBATCH --time=01:30:00
#SBATCH --output=/mnt/home/amitra/chronos-forecasting/reasoning-finetuning/logs/finetune_trend_v4_%j.log
#SBATCH --error=/mnt/home/amitra/chronos-forecasting/reasoning-finetuning/logs/finetune_trend_v4_%j.err
...
TRAIN_SCRIPT="$REPO_ROOT/reasoning-finetuning/scripts/fine_tune_trend_v4.py"
...
echo ""
echo "--- Fine-tune chronos-t5-small (v4 — decoder-mode conditioning) ---"
